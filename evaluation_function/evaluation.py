...
def evaluation_function(response: Any, answer: Any, params: Params) -> Result:
    ...
    chatbot_response = invoke_agent_no_memory(response, conversation_history, summary, conversationalStyle, session_id=uuid.uuid4()) # TODO: to be replaced by Question ID set by web client
    end_time = time.time()
...
def invoke_agent_no_memory(query: str, conversation_history: list, summary: str, conversationalStyle: str, session_id: str):
    ...
    config = {"configurable": {"thread_id": session_id, "summary": summary, "conversational_style": conversationalStyle}}
