...
class SocraticAgent:
    def __init__(self):
        ...
        self.role_prompt = socratic_role_prompt
    ...
    def should_summarize(self, state: State) -> str:
        ...
        If there are more than 'max_messages_to_summarize' messages, then we summarize the conversation.
...
agent = SocraticAgent()
def invoke_socratic_agent(query: str, conversation_history: list, summary: str, conversationalStyle: str, question_response_details: str, session_id: str) -> InvokeAgentResponseType:
